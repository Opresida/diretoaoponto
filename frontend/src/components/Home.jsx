    ...
    <div className="min-h-full p-4 max-w-md mx-auto">
      <header className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2.5">
          <img src="/logo-white.png" alt="Direto ao Ponto" className="h-7 w-auto" />
          <div>
            <div className="text-sm font-bold leading-tight">{user?.name}</div>
            <div className="text-[11px] text-slate-400 flex items-center gap-1">
              {online ? <Wifi size={11} className="text-ok" /> : <WifiOff size={11} className="text-amber-400" />}
      ...
      {pending === 0 && (
        <div className="w-full mb-4 bg-[#2E9E4F]/10 border border-[#2E9E4F]/40 rounded-el p-3 flex items-center gap-2 text-sm text-[#8ce0a5]">
