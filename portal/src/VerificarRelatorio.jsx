  ...
  if (!r) return (
    <div className="page">
      <div className="card" style={{ padding: 24, maxWidth: 440, width: "100%" }}>
        ...
        <div className="skeleton" style={{ height: 70, width: "100%", marginBottom: 16 }} />
    ...
    <div className="page">
      <div className="card" style={{ padding: 24, maxWidth: 440, width: "100%" }}>
        ...
        {(s.instituto || s.pesquisa) && (
          <div style={{ background: "#FBF7F7", border: "1px solid #EBDFDF", borderRadius: 12, padding: 14, marginBottom: 16 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, fontWeight: 600, fontSize: 14 }}>
              <FileText size={15} style={{ color: "#A81824" }} />{s.pesquisa ?? "—"}
            </div>
            {s.instituto && <div style={{ fontSize: 12, color: "#6B7280", marginTop: 2 }}>{s.instituto}</div>}
